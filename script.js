...
function renderResult(data, url, network) {
  ...
  resultSource.innerHTML = `${linkIcon} Izvor: <a href="${escHtml(url)}" target="_blank" rel="noopener noreferrer" style="color: inherit; text-decoration: underline;">${escHtml(url)}</a>`;
